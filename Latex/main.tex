...
\usepackage[backend=biber, citestyle=verbose-ibid, bibstyle=numeric, sorting=none, ibidtracker=false]{biblatex}
...
esclusivamente dal settore privato \footcite{longpre_2022}. Nel sottoinsieme
...
del termine ``stocastico'' non è casuale: la decisione non discende
dall'applicazione di una regola esplicita, ma dal superamento di una soglia da
parte di un punteggio prodotto per inferenza. Come si dimostrerà
