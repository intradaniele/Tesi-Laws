...
\usepackage[backend=biber, citestyle=verbose-ibid, bibstyle=numeric, sorting=none, citetracker=false, ibidtracker=false, loccittracker=false, opcittracker=false]{biblatex}
...
minimizzare i rischi a beneficio dell'industria e degli interessi nazionali; il parallelo con il caso Anthropic, discusso nella Sezione~\ref{sec:governance}, è ripreso più avanti. Sul
...
architettura di raccolta dati, in tempo di pace è sempre potenzialmente
