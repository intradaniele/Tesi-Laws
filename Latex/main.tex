...
\begin{minipage}{0.6\textwidth}
\epigraph{
    ``Weapon systems that could, by themselves, target and attack human beings are morally repugnant and politically unacceptable. ''
...
sperimentalmente nel \hyperref[cap5]{Capitolo Quinto}, una perturbazione applicata all'ingresso
...
sono descritte nel \hyperref[cap4]{Capitolo Quarto} e non anticipate qui.
