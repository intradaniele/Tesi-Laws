...
Ringrazio sentitamente il Prof. Rivolta per avermi supportato e guidato nella parte sperimentale di questo lavoro.
...
\begin{itemize}
    ...
    \item \textbf{Quantificazione sperimentale delle vulnerabilità:} valutare empiricamente la robustezza dei modelli di Object Detection (nello specifico l'architettura YOLO, \textit{You Only Look Once}) utilizzati nei sistemi di targeting, con tecniche di \textit{Adversarial Machine Learning} che mostrano quanto sia facile compromettere la ``confidence'' algoritmica. La valutazione è condotta su due dataset aerei indipendenti, per capire se le vulnerabilità osservate siano una caratteristica del singolo dataset o si replichino su domini distinti. Entrano nel conto anche gli altri fattori che possono influenzare la decisione di ``engagement'', come le fonti aperte (OSINT, \textit{Open Source Intelligence}) e il comportamento del soggetto identificato da YOLO, riprodotti tramite un simulatore (\textit{LAWS-SIM}).
    \item \textbf{Misurazione dei limiti di una contromisura passiva:} ottimizzare una perturbazione avversariale indossabile e misurarne statisticamente l'efficacia contro un rilevatore impiegato da piattaforma aerea, per stimare quanta protezione una contromisura di questo tipo possa realisticamente offrire. La perturbazione così caratterizzata è la componente percettiva di un dispositivo indossabile completo, il ``C.A.R.E. Kit'', la cui realizzazione fisica è delineata fra gli sviluppi futuri.
\end{itemize}
...
intercontinentale, e decise di non ordinare il contrattacco nucleare.
...
in cui l'operatore è escluso dal processo decisionale letale.\footnote{La
...
tecnologie digitali, definita in letteratura come \textit{Dual-Use}. A
differenza delle storiche tecnologie militari, come l'energia nucleare o
l'ingegneria aerospaziale, la cui evoluzione era confinata entro laboratori
governativi, l'odierno ecosistema dell'intelligenza artificiale è trainato quasi
esclusivamente dal settore privato \footcite{longpre_2022}. Da questa
...
Questa convergenza si traduce nella militarizzazione di quello che Shoshana
Zuboff ha definito ``Capitalismo della Sorveglianza'': un sistema economico
...
in profitto e potere. Come analizzato criticamente da Olivieri nel quadro della
...
sviluppare letalità autonoma \footcite{longpre_2022}. Diviene così quasi
...
come l'AI Act \footcite{wareham_2020} nel tentativo di ingabbiare giuridicamente
una tecnologia da cui dipende strutturalmente. In questo divario l'etica viene
piegata agli interessi del Dual-Use e del monopolio tecnologico, mentre si
confrontano chi scrive il codice e chi scrive le regole.
...
Questa condanna istituzionale nasce dalla mobilitazione della società civile
...
Against Killer Robots} di Human Rights Watch \footcite{wareham_2020}, da cui
...
ha supportato apertamente un bando preventivo totale.
 
Dal 2013, 97 Stati hanno elaborato la propria posizione sui LAWS in sede
multilaterale \footcite{wareham_2020} e hanno riconosciuto che la rimozione
dell'intervento umano nell'uso della forza produce problemi etici, legali,
operativi e tecnologici. Circa due terzi dei contribuenti fanno parte della CCW
...
prematura la firma di un nuovo negoziato \footcite{ant_pen_escalation}.
...
\textit{killer robots}, ma nel 2018 ha sostenuto che i sistemi ad arma autonomi
...
\footcite{ccw_2019}, un approccio \textit{two way} che riconosce l'importanza
del controllo umano significativo senza escludere lo sviluppo di sistemi
autonomi in determinate circostanze. La ragione è anche industriale: un divieto
...
l'Italia ha esportato circa $23.8$ milioni di euro in sistemi d'arma, fra cui
dodici elicotteri leggeri AW119 Koala e quattro cannoni navali Super Rapid da
$76$ mm.
...
militari \footcite{crosetto_2025_nonpaper}. La logica è la stessa: la capacità
tecnologica viene trattata come condizione di sicurezza irrinunciabile e non
come minaccia da limitare, il che spiega la coerenza fra l'approccio \textit{two
way} sostenuto in sede CCW e l'atteggiamento nazionale. Per l'Italia, rinunciare
...
Gli Stati Uniti hanno mantenuto una posizione sostanzialmente indifferente. Nel
...
2018 la delegazione israeliana ha sostenuto che i sistemi ad arma autonomi non
...
\textit{fire-and-forget}, con la capacità tecnica di essere lanciati,
localizzare autonomamente le emissioni radar nemiche e colpirle con la testata
integrata. L'impiego di questi sistemi da parte dell'Azerbaigian nel conflitto
...
Il conflitto in Ucraina è il primo banco di prova su larga scala per
...
tattica: se il segnale cade, la macchina deve decidere se colpire o rientrare.
La guerra moderna si è così spostata ben oltre i limiti discussi nelle sedi
diplomatiche, e i negoziati diventano obsoleti prima ancora di essere firmati.
 
\textbf{Il caso Libico.}
Se l'Ucraina è stata il laboratorio in cui questi sistemi sono stati sperimentati
su scala, la Libia è stata il teatro del paziente zero. Nel marzo 2020, durante
...
sistemi d'arma autonomi letali aerei Kargu-2, di produzione turca, sono stati
...
\label{fig:kargu}
\caption{Reperti fotografici ed estratti analitici del sistema STM Kargu-2 nel teatro libico. Fonte: Annex 30 del rapporto finale del Panel of Experts on Libya \footcite{un_libya_2021}.}
\end{figure}
...
e il soggetto umano \textit{respons-abile}, ovvero capace di rispondere e di
...
processo decisionale dalla semantica umana all'inferenza stocastica.\footnote{L'impiego
del termine ``stocastico'' non è casuale: a differenza del ragionamento umano,
che opera per nessi semantici e causali, la macchina mappa vettori di dati in
distribuzioni di probabilità per approssimare un risultato. Come si dimostrerà
sperimentalmente nel Capitolo Quinto, una perturbazione applicata all'ingresso
altera direttamente queste distribuzioni di probabilità, fino a far attraversare
la soglia decisionale a predizioni che le erano già prossime, senza che alcun
parametro del sistema venga toccato. L'esito dell'ingaggio dipende quindi da una
traslazione statistica priva di fondamenti semantici.} Come verrà spiegato nel
Capitolo Quarto, la macchina identifica un bersaglio calcolando distribuzioni di
probabilità per minimizzare una funzione di perdita preimpostata, ma è
strutturalmente incapace di \textit{rispondere} del proprio tasso d'errore
nell'ingaggio \footcite{simmons_edler_2025}.
...
fragilità e diventa un apparato \textit{not-Safe-by-Design}.\footnote{Nel
...
architettura di raccolta dati, in tempo di pace sempre potenzialmente
riconvertibile in strumento di controllo.

Siamo di fronte a \textit{``un potere che non amministra la vita, ma la regola
...
Se l'algoritmo viene ottimizzato per minimizzare i falsi negativi, ovvero la
mancata individuazione del nemico, la \textit{loss function} accetta
matematicamente l'inclusione di civili innocenti fra i falsi positivi: la
necropolitica diventa un parametro di \textit{tuning} ingegneristico.
...
nel Capitolo \ref{cap1} mostra così un limite strutturale non casuale, ma
...
sviluppo \footcite{wareham_2020}, e non esiste a oggi un quadro normativo
...
L'\textit{accountability gap} illustrato nel Capitolo \ref{cap1} non nasce quindi
...
Il punteggio assegnato non è una certezza, ma un \textit{confidence score}
stocastico. Stabilire a quale punteggio un individuo diventi un bersaglio
...
mostrato empiricamente nel Capitolo Quinto, in una rete di \textit{Computer
...
discusso nel Capitolo \ref{cap1}: nessuna quantità di \textit{data fusion}
...
dati rischia di generare nuove forme di dominio asimmetrico. Si scaglia inoltre
contro lo sviluppo di armi autonome, esige che l'intelligenza artificiale venga
disarmata e riafferma l'inaccettabilità morale di delegare a una macchina
decisioni irreversibili di vita o di morte. Resta però da chiedersi se il vertice
spirituale di una singola confessione religiosa, che è al contempo Capo di Stato
dotato di uno schiacciante peso geopolitico, possa arrogarsi il diritto, o
disporre della forza materiale, di stabilire i confini etici di un fenomeno
tecnico-militare globale: in uno scenario multipolare dominato dal realismo,
l'autorità morale resta un argine strutturalmente insufficiente.
...
avvalso dell'infrastruttura dell'LLM Claude, per il tramite di Palantir
...
OpenAI a offrirsi per colmare il vuoto operativo. L'accusa formale, che Anthropic
potesse codificare limitazioni persistenti nel modello, trova riscontro negli
studi sui cosiddetti \textit{sleeper agents}, che dimostrano come comportamenti
nascosti in un LLM possano sopravvivere all'addestramento di sicurezza standard
\footcite{hubinger_2024_sleeper}, sebbene tale ricerca nasca per difendere i
modelli da attori malevoli e non per descrivere la condotta legittima del
fornitore.
...
mediante un attore terzo \footcite{shevlane_2022_access}. Raggiunto il secondo
livello, il controllo tecnico che il developer conserva si riduce drasticamente,
perché l'\textit{enforcement} della policy dipende ormai da clausole contrattuali
e non più da un interruttore direttamente azionabile.
...
necessità dell'analisi sperimentale affrontata nei capitoli seguenti: misurare
quanto sia manipolabile il canale percettivo su cui questi sistemi fondano la
...
sono descritte nel Capitolo \ref{cap4} e non anticipate qui.
...
architetture descritte nel Capitolo \ref{cap2} combinano la percezione con
...
framework descritto nel Capitolo \ref{cap4} li tratta come livelli di un unico
sistema, con lo statuto epistemico differenziato che il Capitolo \ref{cap5}
dichiara e mantiene.


% =====================================================================
% REVISIONE HUMANIZER - Blocco 4A: Capitolo Quarto, Architettura LAWS-SIM
% Corrisponde alle righe 1111-1296 di main.tex
% Solo prosa modificata. I due ambienti TikZ, le equazioni, le didascalie
% e tutti i \footcite / \label / \ref sono copiati byte per byte
% dal sorgente originale.
% =====================================================================
...
reali e un ambiente simulato che ne propaga gli effetti fino a una decisione,
...
sintetiche generate da distribuzioni scelte in fase di progettazione, e i loro
risultati hanno lo statuto di conseguenze di un modello, non di osservazioni.
Questa asimmetria è deliberata e ricorre nella discussione dei risultati.

\textbf{Il ponte di interscambio.}
Valutare YOLOv8 a ogni passo temporale imporrebbe un costo proibitivo, dato il
prodotto fra numero di entità visibili e centinaia di iterazioni per scenario. I
...
verifica sono riportate nel Capitolo \ref{cap5}, e la questione è ripresa fra le
limitazioni.
...
complessivo di aggiornamenti disponibili. La patch valutata nel Capitolo
\ref{cap5} corrisponde all'ultimo aggiornamento eseguito e non a quello di
...
del primo insieme. L'effetto della correzione è quantificato nel Capitolo
\ref{cap5}: le stime puntuali risultano invariate entro il terzo decimale,
...
definita nella Sezione \ref{sec:metriche}; il terzo intervallo corrisponde alla
condizione di ingaggio ravvicinato modellata dal simulatore.
...
La strumentazione diretta del ciclo di ottimizzazione, condotta su un campione di $200$ iterazioni con contatori su tutti i punti di uscita, attribuisce l'intero scarto al filtro di rilevanza tattica ($75$ iterazioni su $200$, coerente con la frazione misurata sul run completo).
...
con valori rispettivamente di $0.8248$, $0.9690$ e $1.0000$: l'invarianza
...
\bottomrule
\end{tabular}
\caption{Effetto della decorrelazione temporale: stima puntuale invariata, ampiezza dell'intervallo di confidenza circa cinque volte maggiore.}
\label{tab:decorrelazione}
\end{table}

Le stime puntuali coincidono entro il terzo decimale; l'ampiezza dell'intervallo aumenta di un fattore prossimo a cinque. La significatività non cambia, con valore di probabilità inferiore a $0.0001$ in entrambi i casi: la correzione modifica la stima dell'incertezza e non la conclusione.
...
\midrule
VisDrone & $0.3$ & $0.4625$ & $0.4375$ & $-0.025$ & $0.535$ \\
VisDrone & $0.5$ & $0.1125$ & $0.0500$ & $-0.063$ & $0.0136$ \\
VisDrone & $0.7$ & $0.0000$ & $0.0000$ & $0.000$ & $1.000$ \\
\addlinespace
Okutama & $0.3$ & $0.3700$ & $0.2867$ & $-0.083$ & $0.0108$ \\
Okutama & $0.5$ & $0.0967$ & $0.0433$ & $-0.053$ & $<0.0001$ \\
Okutama & $0.7$ & $0.0000$ & $0.0000$ & $0.000$ & $1.000$ \\
\bottomrule
\end{tabular}
...
Il segno della differenza è negativo su entrambi i domini: la perturbazione riduce il numero di rilevamenti spuri.
...
L'impiego di sistemi d'arma autonomi letali sposta la selezione del bersaglio da un operatore a un modello statistico, e con essa il presupposto di fatto su cui il Diritto Internazionale Umanitario fonda il principio di distinzione. Lo stallo dei negoziati internazionali, esaminato nel Capitolo~\ref{cap1}, e la dissoluzione della responsabilità individuale nella catena algoritmica, discussa nel Capitolo~\ref{cap2}, lasciano il requisito di controllo umano significativo privo di verifica tecnica indipendente. Il presente lavoro ha affrontato questa lacuna per via sperimentale: ha sottoposto il canale sensoriale di un sistema di percezione a un attacco avversariale controllato e ne ha misurato il degrado con un protocollo statistico esplicito.
...
La correzione dei livelli di simulazione e fusione consentirebbe inoltre di
